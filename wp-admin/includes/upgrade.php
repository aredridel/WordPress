...
require_once(ABSPATH . 'wp-admin/includes/Modyllic/lib/SQL.php');
...
function dbDelta( $queries = '', $execute = true ) {
	...
	foreach ( $cqueries as $table => $qry ) {
		...
		$parser->partial($newschema, $qry, 'Internal Schema', ';');

    }

	$oldschema = SQL_Schema_Loader::from_db($wpdb->dbhost, $wpdb->dbname, $wpdb->dbuser, $wpdb->dbpassword);

	$diff = new SQL_Diff( $oldschema, $newschema );
	$gen = new SQL_Generator_NativeSQL();

	/// @todo: Make sure nothing gets dropped.
